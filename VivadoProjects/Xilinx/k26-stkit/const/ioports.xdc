...
# J16 27
set_property IOSTANDARD LVCMOS33 [get_ports ext_AUD_BCLK_0]
set_property IOSTANDARD LVCMOS33 [get_ports ext_AUD_DACLRCLK_0]
set_property IOSTANDARD LVCMOS33 [get_ports oAUD_DACDAT_0]
set_property IOSTANDARD LVCMOS33 [get_ports midi_rxd_0]
set_property IOSTANDARD LVCMOS33 [get_ports midi_txd_0]
set_property IOSTANDARD LVCMOS33 [get_ports {Led_out[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Led_out[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Led_out[2]}]

set_property SLEW SLOW [get_ports ext_AUD_BCLK_0]
set_property SLEW SLOW [get_ports ext_AUD_DACLRCLK_0]
set_property SLEW SLOW [get_ports oAUD_DACDAT_0]
#set_property SLEW SLOW [get_ports "midi_rxd_0"]; # Net name HDA14
set_property SLEW SLOW [get_ports midi_txd_0]
...
set_property DRIVE 4 [get_ports ext_AUD_BCLK_0]
set_property DRIVE 4 [get_ports ext_AUD_DACLRCLK_0]
set_property DRIVE 4 [get_ports oAUD_DACDAT_0]
#set_property DRIVE 4   [get_ports "midi_rxd_0"]; # Net name HDA14
set_property DRIVE 4 [get_ports midi_txd_0]
set_property DRIVE 4 [get_ports {Led_out[0]}]
set_property DRIVE 4 [get_ports {Led_out[1]}]
set_property DRIVE 4 [get_ports {Led_out[2]}]
