...
proc create_root_design { parentCell } {
  ...
  set ext_AUD_DACLR_CLK_0 [ create_bd_port -dir IO -type clk ext_AUD_DACLR_CLK_0 ]
  ...
  # Create instance: audio_clk_mux_ip_0, and set properties
  set audio_clk_mux_ip_0 [ create_bd_cell -type ip -vlnv Holotronic.dk:producer:audio_clk_mux_ip:1.1 audio_clk_mux_ip_0 ]
  ...
  if { [catch {set audio_i2s_driver_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {127.007} \
   CONFIG.CLKOUT1_PHASE_ERROR {141.876} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {90.416666} \
   CONFIG.CLKOUT2_DRIVES {Buffer} \
   CONFIG.CLKOUT2_JITTER {151.717} \
   CONFIG.CLKOUT2_PHASE_ERROR {141.876} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {33.90625} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_DRIVES {Buffer} \
   CONFIG.CLKOUT3_JITTER {163.461} \
   CONFIG.CLKOUT3_PHASE_ERROR {141.876} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {24.675} \
  ...
  if { [catch {set holosynth_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $holosynth_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  connect_bd_net -net Net [get_bd_ports ext_AUD_B_CLK_0] [get_bd_pins audio_clk_mux_ip_0/ext_AUD_B_CLK]
  connect_bd_net -net Net1 [get_bd_ports ext_AUD_DACLR_CLK_0] [get_bd_pins audio_clk_mux_ip_0/ext_AUD_DACLR_CLK]
  connect_bd_net -net Net2 [get_bd_ports ext_AUD_ADCLR_CLK_0] [get_bd_pins audio_clk_mux_ip_0/ext_AUD_ADCLR_CLK]
  connect_bd_net -net audio_clk_mux_ip_0_ext_playback_lrclk [get_bd_pins audio_clk_mux_ip_0/ext_playback_lrclk] [get_bd_pins audio_i2s_driver_0/iAUD_DACLRCK] [get_bd_pins holosynth_0/AUD_DACLRCK]
  connect_bd_net -net audio_clk_mux_ip_0_ext_shift_b_clk [get_bd_pins audio_clk_mux_ip_0/ext_shift_b_clk] [get_bd_pins audio_i2s_driver_0/iAUD_BCLK]
  ...
  connect_bd_net -net holosynth_0_data_to_cpu [get_bd_pins holosynth_0/data_to_cpu] [get_bd_pins uioreg_io_0/con_datain]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins audio_clk_mux_ip_0/s00_axi_aresetn] [get_bd_pins audio_i2s_driver_0/reset_reg_N] [get_bd_pins holosynth_0/reset_n] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins uioreg_io_0/s00_axi_aresetn] [get_bd_pins uioreg_io_1/s00_axi_aresetn]
  connect_bd_net -net uioreg_io_0_con_adrout [get_bd_pins holosynth_0/cpu_addr] [get_bd_pins uioreg_io_0/con_adrout]
  connect_bd_net -net uioreg_io_0_con_dataout [get_bd_pins holosynth_0/data_from_cpu] [get_bd_pins uioreg_io_0/con_dataout]
  connect_bd_net -net uioreg_io_0_con_read_out [get_bd_pins holosynth_0/cpu_read] [get_bd_pins uioreg_io_0/con_read_out]
  connect_bd_net -net uioreg_io_0_con_write_out [get_bd_pins holosynth_0/cpu_write] [get_bd_pins uioreg_io_0/con_write_out]
