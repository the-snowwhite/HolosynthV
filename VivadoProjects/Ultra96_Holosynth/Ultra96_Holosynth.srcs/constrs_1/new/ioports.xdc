...
set_property PACKAGE_PIN E6 [get_ports midi_rxd_0]
set_property PACKAGE_PIN E5 [get_ports midi_txd_0]

set_property PACKAGE_PIN A6 [get_ports {Led_out[0]}]
set_property PACKAGE_PIN C7 [get_ports {Led_out[1]}]
#set_property PACKAGE_PIN U2 [get_ports {Led_out[0]}]
#set_property PACKAGE_PIN U1 [get_ports {Led_out[1]}]
