...
set psu_mio_init_data {
    ...
    mask_write 0XFF1800A8 0x000000FE 0x00000040
    ...
    mask_write 0XFF1800AC 0x000000FE 0x00000040
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x023FFFDE
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x01FFFFFF
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x03F3FEEB
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x000F807C 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
