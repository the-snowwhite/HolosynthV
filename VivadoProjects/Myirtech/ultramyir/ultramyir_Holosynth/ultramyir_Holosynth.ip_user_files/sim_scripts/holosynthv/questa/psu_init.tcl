...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00B8 0x01003F07 0x01000302
		...
		# 6 bit divider
		# PSU_CRL_APB_PL0_REF_CTRL_DIVISOR0                                               0x10
    ...
    #  usually an issue, but designers must be aware.)
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E00C0, 0x013F3F07U ,0x01011002U)  */
    mask_write 0XFF5E00C0 0x013F3F07 0x01011002
		...
		# 6 bit divider
		# PSU_CRL_APB_PL1_REF_CTRL_DIVISOR0                                               0x8
    ...
    #  usually an issue, but designers must be aware.)
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E00C4, 0x013F3F07U ,0x01010802U)  */
    mask_write 0XFF5E00C4 0x013F3F07 0x01010802
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD0700DC 0xFFFFFFFF 0x0B340301
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x0826100A
    ...
    mask_write 0XFD080180 0xFFFFFFFF 0x00000A34
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B03004
    ...
    mask_write 0XFF18013C 0x03FFFFFF 0x03FFFFFF
		...
		#(OFFSET, MASK, VALUE)      (0XFF180140, 0x03FFFFFFU ,0x023FEF4EU)  */
    mask_write 0XFF180140 0x03FFFFFF 0x023FEF4E
    ...
    mask_write 0XFF180148 0x03FFFFFF 0x03FFFFFF
		...
		#(OFFSET, MASK, VALUE)      (0XFF18014C, 0x03FFFFFFU ,0x01FFFFBDU)  */
    mask_write 0XFF18014C 0x03FFFFFF 0x01FFFFBD
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FFFDD5
    ...
    mask_write 0XFF180164 0x03FFFFFF 0x03FFFFFF
		...
		#(OFFSET, MASK, VALUE)      (0XFF180168, 0x03FFFFFFU ,0x03F3FECBU)  */
    mask_write 0XFF180168 0x03FFFFFF 0x03F3FECB
...
set psu_serdes_init_data {
    ...
    #  - 108MHz, 0xF - 125MHz, 0x10 - 135MHz, 0x11 - 150 MHz. 0x12 to 0x1F - R
    # eserved
		# PSU_SERDES_PLL_REF_SEL3_PLLREFSEL3                                              0xE

		# PLL3 Reference Selection Register
		#(OFFSET, MASK, VALUE)      (0XFD41000C, 0x0000001FU ,0x0000000EU)  */
    mask_write 0XFD41000C 0x0000001F 0x0000000E
    ...
    # 2 - Sata1, 3 - USB0, 4 - DP.0, 5 - SGMII1, 6 - Unused, 7 - Unused
		...
		#(OFFSET, MASK, VALUE)      (0XFD410010, 0x00000077U ,0x00000021U)  */
    mask_write 0XFD410010 0x00000077 0x00000021
    ...
    # 2 - Sata1, 3 - USB1, 4 - DP.0, 5 - SGMII3, 6 - Unused, 7 - Unused
		...
		#(OFFSET, MASK, VALUE)      (0XFD410014, 0x00000077U ,0x00000043U)  */
    mask_write 0XFD410014 0x00000077 0x00000043
		# : CHECKING PLL LOCK
