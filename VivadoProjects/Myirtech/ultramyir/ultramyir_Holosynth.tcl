...
#
# ultramyir_Holosynth.tcl: Tcl script for re-creating project 'ultramyir_Holosynth'
#
# Generated by Vivado on Tue Jun 22 21:26:10 CEST 2021
...
#
# 1. This project restoration tcl script (ultramyir_Holosynth.tcl) that was generated.
#
...
#    "/work/VivadoProjects/Myirtech/ultramyir/const/ioports.xdc"
#    "/work/VivadoProjects/Myirtech/ultramyir/const/timing.xdc"
#    "/work/VivadoProjects/Myirtech/ultramyir/const/debug.xdc"
#    "/work/VivadoProjects/Myirtech/ultramyir/scripts/bitfile2tftp.tcl"
#
#*****************************************************************************************
...
set _xil_proj_name_ "ultramyir_Holosynth"
...
set script_file "ultramyir_Holosynth.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/ultramyir_Holosynth"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "/tools/Xilinx/Vivado/2020.2/data/boards/board_files"]" -objects $obj
...
# audio_i2s_driver, audio_i2s_timing_gen, audio_mux, holosynth
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS { \
     ...
     0#USB 0#Gem \
     0#USB 0#Gem \
     1#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#PCIE#GPIO1 \
     1#SD 1#USB \
     1#SD 1#USB \
     1#SD 1#USB \
     1#SD 1#USB \
...
if { [get_property IS_LOCKED [ get_files -norecurse holosynthv.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../ultramyir_Holosynth/ultramyir_Holosynth.srcs/sources_1/bd/holosynthv/hdl/holosynthv_wrapper.v" ]
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu3eg-sfvc784-1-e -flow {Vivado Implementation 2020} -strategy "Performance_Explore" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
