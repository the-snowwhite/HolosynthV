...
#create_generated_clock -name holosynthv_i/holosynth_0/inst/synthesizer_inst/synth_engine_inst/synth_clk_gen_inst/sCLK_XVXENVS_reg_0 -source [get_pins {holosynthv_i/zynq_ultra_ps_e_0/inst/PS8_i/PLCLK[1]}] -divide_by 2 [get_pins holosynthv_i/holosynth_0/inst/synthesizer_inst/synth_engine_inst/synth_clk_gen_inst/sCLK_XVXENVS_reg/Q]
#create_generated_clock -name holosynthv_i/holosynth_0/inst/synthesizer_inst/synth_engine_inst/synth_clk_gen_inst/sCLK_XVXOSC_reg_0 -source [get_pins {holosynthv_i/zynq_ultra_ps_e_0/inst/PS8_i/PLCLK[1]}] -divide_by 4 [get_pins holosynthv_i/holosynth_0/inst/synthesizer_inst/synth_engine_inst/synth_clk_gen_inst/sCLK_XVXOSC_reg/Q]
...
#set_clock_groups -physically_exclusive -group clk_out1_holosynthv_clk_wiz_0_0 -group clk_out2_holosynthv_clk_wiz_0_0
...
#set_clock_groups -asynchronous -group [get_clocks clk_pl_0] -group [get_clocks clk_out1_holosynthv_clk_wiz_0_0]
#set_clock_groups -asynchronous -group [get_clocks clk_pl_0] -group [get_clocks clk_out2_holosynthv_clk_wiz_0_0]
#set_clock_groups -asynchronous -group [get_clocks clk_out1_holosynthv_clk_wiz_0_0] -group [get_clocks clk_pl_0]
#set_clock_groups -asynchronous -group [get_clocks clk_out2_holosynthv_clk_wiz_0_0] -group [get_clocks clk_pl_0]
