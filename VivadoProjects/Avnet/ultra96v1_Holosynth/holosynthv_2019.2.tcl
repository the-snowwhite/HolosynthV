...
################################################################
# This is a generated script based on design: holosynthv
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: audio_mux_0, and set properties
  set block_name audio_mux
  set block_cell_name audio_mux_0
  if { [catch {set audio_mux_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $audio_mux_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT4_JITTER {240.423} \
   CONFIG.CLKOUT4_PHASE_ERROR {410.561} \
   CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {180.83333} \
   CONFIG.CLKOUT4_USED {false} \
   CONFIG.CLKOUT5_DRIVES {Buffer} \
   CONFIG.CLKOUT6_DRIVES {Buffer} \
   CONFIG.CLKOUT7_DRIVES {Buffer} \
   CONFIG.FEEDBACK_SOURCE {FDBK_AUTO} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {66.625} \
  ...
  # Create instance: holosynth_audio, and set properties
  set holosynth_audio [ create_bd_cell -type ip -vlnv machinekit.io:user:hm2_axilite_int:1.0 holosynth_audio ]
  set_property -dict [ list \
   CONFIG.C_S_AXI_ADDR_WIDTH {5} \
 ] $holosynth_audio

  # Create instance: holosynth_midi, and set properties
  set holosynth_midi [ create_bd_cell -type ip -vlnv machinekit.io:user:hm2_axilite_int:1.0 holosynth_midi ]
  set_property -dict [ list \
   CONFIG.C_S_AXI_ADDR_WIDTH {5} \
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins holosynth_uio/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins holosynth_midi/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins holosynth_audio/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net audio_clk_mux_core_0_i2s_enable_o [get_bd_pins audio_clk_mux_core_0/i2s_enable_o] [get_bd_pins audio_i2s_driver_0/i2s_enable]
  ...
  connect_bd_net -net holosynth_0_xxxx_zero_clk [get_bd_pins fifo_generator_0/wr_clk] [get_bd_pins fifo_generator_1/wr_clk] [get_bd_pins holosynth_0/xxxx_zero]
  connect_bd_net -net holosynth_audio_ADDR [get_bd_pins audio_mux_0/address] [get_bd_pins holosynth_audio/ADDR]
  connect_bd_net -net holosynth_audio_IBUS [get_bd_pins audio_mux_0/datain] [get_bd_pins holosynth_audio/IBUS]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins audio_clk_mux_core_0/reset_n] [get_bd_pins audio_i2s_driver_0/reset_reg_N] [get_bd_pins holosynth_0/reset_data_n] [get_bd_pins holosynth_0/reset_reg_n] [get_bd_pins holosynth_audio/S_AXI_ARESETN] [get_bd_pins holosynth_midi/S_AXI_ARESETN] [get_bd_pins holosynth_uio/S_AXI_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00000080 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs holosynth_midi/S_AXI/reg0] -force
